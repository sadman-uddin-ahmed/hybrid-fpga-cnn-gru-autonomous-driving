...
module cnn_feature_extractor_bram_system (
    ...
    localparam CONV2_WEIGHT_VALUES_PER_CHANNEL  = 144;
    localparam CONV2_WEIGHT_BANK_TOTAL_VALUES   = 1152;
    localparam CONV2_BIAS_BANK_TOTAL_VALUES     = 8;
    ...
    wire [10:0] conv2_weight_read_address;
    reg signed [7:0] conv2_weight_read_data_0;
    reg signed [7:0] conv2_weight_read_data_1;
    reg signed [7:0] conv2_weight_read_data_2;
    reg signed [7:0] conv2_weight_read_data_3;
    wire [2:0] conv2_bias_read_address;
    reg signed [31:0] conv2_bias_read_data_0;
    reg signed [31:0] conv2_bias_read_data_1;
    reg signed [31:0] conv2_bias_read_data_2;
    reg signed [31:0] conv2_bias_read_data_3;
    ...
    wire [4:0] conv2_weight_write_output_channel;
    wire [7:0] conv2_weight_write_term_address;
    wire [1:0] conv2_weight_write_bank_select;
    wire [2:0] conv2_weight_write_channel_group;
    wire [10:0] conv2_weight_write_bank_address;
    wire [1:0] conv2_bias_write_bank_select;
    wire [2:0] conv2_bias_write_bank_address;
    assign conv2_weight_write_output_channel =
        conv2_weight_memory_write_address / CONV2_WEIGHT_VALUES_PER_CHANNEL;
    assign conv2_weight_write_term_address =
        conv2_weight_memory_write_address % CONV2_WEIGHT_VALUES_PER_CHANNEL;
    assign conv2_weight_write_bank_select =
        conv2_weight_write_output_channel[1:0];
    assign conv2_weight_write_channel_group =
        conv2_weight_write_output_channel[4:2];
    assign conv2_weight_write_bank_address =
        (conv2_weight_write_channel_group * CONV2_WEIGHT_VALUES_PER_CHANNEL) +
        conv2_weight_write_term_address;
    assign conv2_bias_write_bank_select =
        conv2_bias_memory_write_address[1:0];
    assign conv2_bias_write_bank_address =
        conv2_bias_memory_write_address[4:2];
    (* ram_style = "block" *)
    reg signed [7:0] conv1_to_conv2_memory_array [0:CONV1_POOLED_TOTAL_VALUES-1];
    (* ram_style = "block" *)
    reg signed [7:0] conv2_weight_memory_bank_0 [0:CONV2_WEIGHT_BANK_TOTAL_VALUES-1];
    (* ram_style = "block" *)
    reg signed [7:0] conv2_weight_memory_bank_1 [0:CONV2_WEIGHT_BANK_TOTAL_VALUES-1];
    (* ram_style = "block" *)
    reg signed [7:0] conv2_weight_memory_bank_2 [0:CONV2_WEIGHT_BANK_TOTAL_VALUES-1];
    (* ram_style = "block" *)
    reg signed [7:0] conv2_weight_memory_bank_3 [0:CONV2_WEIGHT_BANK_TOTAL_VALUES-1];
    (* ram_style = "distributed" *)
    reg signed [31:0] conv2_bias_memory_bank_0 [0:CONV2_BIAS_BANK_TOTAL_VALUES-1];
    (* ram_style = "distributed" *)
    reg signed [31:0] conv2_bias_memory_bank_1 [0:CONV2_BIAS_BANK_TOTAL_VALUES-1];
    (* ram_style = "distributed" *)
    reg signed [31:0] conv2_bias_memory_bank_2 [0:CONV2_BIAS_BANK_TOTAL_VALUES-1];
    (* ram_style = "distributed" *)
    reg signed [31:0] conv2_bias_memory_bank_3 [0:CONV2_BIAS_BANK_TOTAL_VALUES-1];
    (* ram_style = "block" *)
    reg signed [7:0] conv2_pooled_output_memory_array [0:CONV2_POOLED_OUTPUT_TOTAL_VALUES-1];
    initial begin
        $display("ACTIVE RTL: cnn_feature_extractor_bram_system V4 FOUR-LANE CONV2 BANKS");
    end
    ...
    conv2_pool_bram_core conv2_pool_bram_core_inst (
        ...
        .weight_read_data_0(conv2_weight_read_data_0),
        .weight_read_data_1(conv2_weight_read_data_1),
        .weight_read_data_2(conv2_weight_read_data_2),
        .weight_read_data_3(conv2_weight_read_data_3),
        .bias_read_address(conv2_bias_read_address),
        .bias_read_data_0(conv2_bias_read_data_0),
        .bias_read_data_1(conv2_bias_read_data_1),
        .bias_read_data_2(conv2_bias_read_data_2),
        .bias_read_data_3(conv2_bias_read_data_3),
    ...
    always @(posedge clk) begin
        if (rst) begin
            ...
            conv2_input_read_data <=
                conv1_to_conv2_memory_array[conv2_input_read_address];
        end
    end
    always @(posedge clk) begin
        if (
            conv2_weight_memory_write_enable &&
            (conv2_weight_write_bank_select == 2'd0)
        ) begin
            conv2_weight_memory_bank_0[conv2_weight_write_bank_address] <=
                conv2_weight_memory_write_data;
        end
        conv2_weight_read_data_0 <=
            conv2_weight_memory_bank_0[conv2_weight_read_address];
    end
    always @(posedge clk) begin
        if (
            conv2_weight_memory_write_enable &&
            (conv2_weight_write_bank_select == 2'd1)
        ) begin
            conv2_weight_memory_bank_1[conv2_weight_write_bank_address] <=
                conv2_weight_memory_write_data;
        end
        conv2_weight_read_data_1 <=
            conv2_weight_memory_bank_1[conv2_weight_read_address];
    end
    always @(posedge clk) begin
        if (
            conv2_weight_memory_write_enable &&
            (conv2_weight_write_bank_select == 2'd2)
        ) begin
            conv2_weight_memory_bank_2[conv2_weight_write_bank_address] <=
                conv2_weight_memory_write_data;
        end
        conv2_weight_read_data_2 <=
            conv2_weight_memory_bank_2[conv2_weight_read_address];
    end
    always @(posedge clk) begin
        if (
            conv2_weight_memory_write_enable &&
            (conv2_weight_write_bank_select == 2'd3)
        ) begin
            conv2_weight_memory_bank_3[conv2_weight_write_bank_address] <=
                conv2_weight_memory_write_data;
        end
        conv2_weight_read_data_3 <=
            conv2_weight_memory_bank_3[conv2_weight_read_address];
    end
    always @(posedge clk) begin
        if (
            conv2_bias_memory_write_enable &&
            (conv2_bias_write_bank_select == 2'd0)
        ) begin
            conv2_bias_memory_bank_0[conv2_bias_write_bank_address] <=
                conv2_bias_memory_write_data;
        end
        conv2_bias_read_data_0 <=
            conv2_bias_memory_bank_0[conv2_bias_read_address];
    end
    always @(posedge clk) begin
        if (
            conv2_bias_memory_write_enable &&
            (conv2_bias_write_bank_select == 2'd1)
        ) begin
            conv2_bias_memory_bank_1[conv2_bias_write_bank_address] <=
                conv2_bias_memory_write_data;
        end
        conv2_bias_read_data_1 <=
            conv2_bias_memory_bank_1[conv2_bias_read_address];
    end
    always @(posedge clk) begin
        if (
            conv2_bias_memory_write_enable &&
            (conv2_bias_write_bank_select == 2'd2)
        ) begin
            conv2_bias_memory_bank_2[conv2_bias_write_bank_address] <=
                conv2_bias_memory_write_data;
        end
        conv2_bias_read_data_2 <=
            conv2_bias_memory_bank_2[conv2_bias_read_address];
    end
    always @(posedge clk) begin
        if (
            conv2_bias_memory_write_enable &&
            (conv2_bias_write_bank_select == 2'd3)
        ) begin
            conv2_bias_memory_bank_3[conv2_bias_write_bank_address] <=
                conv2_bias_memory_write_data;
        end
        conv2_bias_read_data_3 <=
            conv2_bias_memory_bank_3[conv2_bias_read_address];
    end
    always @(posedge clk) begin
        if (rst) begin
            ...
            if (conv2_pooled_output_write_enable) begin
                conv2_pooled_output_memory_array[conv2_pooled_output_write_address] <=
                    conv2_pooled_output_write_data;
                conv2_pooled_output_write_address_monitor <=
                    conv2_pooled_output_write_address;
            ...
            conv2_pooled_output_read_data <=
                conv2_pooled_output_memory_array[conv2_pooled_output_read_address];
        end
    end
    always @(posedge clk) begin
        if (rst) begin
            ...
            case (current_state)
                ...
                STATE_COPY_CONV1_REQUEST: begin
                    conv1_pooled_output_read_address <=
                        conv1_to_conv2_copy_index;
                ...
                STATE_COPY_CONV1_CAPTURE: begin
                    conv1_to_conv2_memory_array[conv1_to_conv2_copy_index] <=
                        conv1_pooled_output_read_data;
                ...
                STATE_COPY_CONV1_NEXT: begin
                    if (conv1_to_conv2_copy_index < CONV1_POOLED_TOTAL_VALUES - 1) begin
                        conv1_to_conv2_copy_index <=
                            conv1_to_conv2_copy_index + 1'b1;
                        current_state <= STATE_COPY_CONV1_REQUEST;
                    end else begin
