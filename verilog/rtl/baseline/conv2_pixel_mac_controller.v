...
module conv2_pixel_mac_controller (
    input  wire clk,
    input  wire rst,
    input  wire start,
    ...
    output reg  [4:0] input_channel_index,
        ...
        if (rst) begin
            ...
            case (current_state)
                ...
                STATE_NEXT_KERNEL: begin
                    if (kernel_column_index == 2'd2) begin
                        ...
                        if (kernel_row_index == 2'd2) begin
                            kernel_row_index <= 2'd0;
                            if (input_channel_index == 5'd15) begin
                ...
                STATE_DONE: begin
                    ...
                    // Return to IDLE after one completed output pixel
                    if (!start) begin
                        current_state <= STATE_IDLE;
                    end
                end
